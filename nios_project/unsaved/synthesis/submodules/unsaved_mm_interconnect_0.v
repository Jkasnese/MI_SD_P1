...
module unsaved_mm_interconnect_0 (
	...
	wire  [90:0] btn_s1_agent_rf_source_data;                                                        // btn_s1_agent:rf_source_data -> btn_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] btn_s1_agent_rsp_fifo_out_data;                                                     // btn_s1_agent_rsp_fifo:out_data -> btn_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> btn_s1_agent:cp_valid
	wire  [89:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> btn_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // btn_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> btn_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> btn_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> btn_s1_agent:cp_endofpacket
	...
	wire         btn_s1_agent_rp_valid;                                                              // btn_s1_agent:rp_valid -> router_004:sink_valid
	wire  [89:0] btn_s1_agent_rp_data;                                                               // btn_s1_agent:rp_data -> router_004:sink_data
	wire         btn_s1_agent_rp_ready;                                                              // router_004:sink_ready -> btn_s1_agent:rp_ready
	wire         btn_s1_agent_rp_startofpacket;                                                      // btn_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         btn_s1_agent_rp_endofpacket;                                                        // btn_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         btn_s1_agent_rdata_fifo_src_valid;                                                  // btn_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] btn_s1_agent_rdata_fifo_src_data;                                                   // btn_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         btn_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_002:in_0_ready -> btn_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> btn_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> btn_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // btn_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> btn_s1_agent:rdata_fifo_sink_error
